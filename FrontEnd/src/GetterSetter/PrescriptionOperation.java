...
public class PrescriptionOperation {
    ...
    public PrescriptionOperation(CheckBox select, String prescMedName, Integer prescStock, TextField presQuantity, Double prescPrice, CheckBox morning, CheckBox afternoon, CheckBox evening) {
        this.select = select;
